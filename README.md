...
<h1 align="center">Gald3r for OpenHands</h1>

<p align="center">
  The <strong>OpenHands edition</strong> of Gald3r -- file-based memory, task management, and
  agent orchestration that runs <strong>inside OpenHands</strong>. Part of the Gald3r framework
...
This is the **OpenHands distribution** of Gald3r. The [`openhands/`](./openhands/) folder is a
complete, ready-to-deploy gald3r setup tuned for OpenHands -- drop its contents into your
...
cp -r gald3r_platform_openhands/openhands/. /path/to/your/project/
```

Then open the project in OpenHands and type `@g-status` to confirm gald3r loaded.

> The `openhands/` payload is **additive** -- it drops in gald3r's config + `.gald3r/` state and
