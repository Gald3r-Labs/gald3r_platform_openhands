...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for OpenHands** -- file-based
...
Open this project in **OpenHands** and run **`@g-setup`** -- it initializes gald3r and fills in
